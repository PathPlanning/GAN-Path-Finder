...
usage() { echo "Usage: $0 -d server_data_dir -l server_logs_dir -g gpu-indexes [-i image] [-p port] [-v] [-u]" >&2; }

VERBOSE=false
LOCAL_USER=false
IMAGE_VERSION_ARG="base"
while getopts "d:l:g:p:i:vu" opt
do
    case ${opt} in
...
IMAGE_VERSION="${IMAGE_VERSION_ARG}"
