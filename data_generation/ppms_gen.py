...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_folder', type=str, default='./size_64/20_den/',
                        help='Folder with generated image maps.')
    ...
    for file in files:
        ...
        plt.imsave(fname=file[:-8] + '_log.png', arr=-ppm, cmap='gray')
